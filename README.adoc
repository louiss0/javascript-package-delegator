...
* `jpd _carapace bash` - Print embedded Carapace completion bridge
...
# Carapace completion bridge (hidden command)
jpd _carapace bash
----
...
│   ├── integrate.go    // 'integrate' command logic (warp)
...
│   └── root.go
├── internal            // Integration helpers and embedded completion assets
