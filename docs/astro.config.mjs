...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      description:
        "A universal JavaScript package manager CLI written in Go that delegates to npm, Yarn, pnpm, Bun, and Deno.",
      ...
      head: [
        ...
        },
        {
          ...
          attrs: {
            name: "twitter:image",
            content: "https://jpd-docs.onrender.com/og-image.png",
          },
        },
        // Additional meta tags
        {
          ...
          attrs: {
            name: "keywords",
            content:
              "javascript, package manager, cli, go, npm, yarn, pnpm, bun, deno, universal, delegator",
          },
        },
        {
          tag: "meta",
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            {
              label: "Run in a subproject with --cwd",
              link: "/how-to/run-in-subproject",
            },
            {
              label: "Interactive install & uninstall",
              link: "/how-to/interactive",
            },
        ...
        },
        {
          ...
          items: [
            {
              label: "Mental model (Why / What / How)",
              link: "/explanation/mental-model",
            },
          ],
        },
      ],
      editLink: {
        baseUrl:
          "https://github.com/louiss0/javascript-package-delegator/edit/main/docs/src/content/docs/",
      },
      social: [
        {
          icon: "github",
          label: "GitHub",
          href: "https://github.com/louiss0/javascript-package-delegator",
        },
      ],
    }),
  ],
